...
public class ListServiceForm extends BaseForm{
    ...
    Form current;
    public ListServiceForm(Resources res) {  super("Newsfeed",BoxLayout.y()); //herigate men Newsfeed w l formulaire vertical
        ...
        addTab(swipe,s1, res.getImage("ttt.jpg"),"","",res);
...
//        System.out.println("user connecté email ="+ SessionManager.getEmail());
        ...
        RadioButton mesListes = RadioButton.createToggle("Demandes", barGroup);
       ...
       // bindButtonSelection(partage, arrow);
        ...
        ArrayList<Service>list = ServiceService.getInstance().affichageService();
        
        for(Service rec : list ) {
            // String urlImage ="ttt.jpg";//image statique pour le moment ba3d taw fi  videos jayin nwarikom image 
            
             Image placeHolder = Image.createImage(120, 90);
             EncodedImage enc =  EncodedImage.createFromImage(placeHolder,false);
            // URLImage urlim = URLImage.createToStorage(enc URLImage.RESIZE_SCALE);
    ...
    private void addButton(Service rec , Resources res) {
       ...
       // Button image = new Button(img.fill(width, height));
        ...
        Label nomService = new Label("Nom Service : "+rec.getNomService(),"NewsTopLine2");
       ...
       /* lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette demande ?","Annuler","Oui")) {
                ...
                if(ServiceDemande.getInstance().deleteDemande(rec.getId_secteur())) {
      ...
      /* lModifier.addPointerPressedListener(l -> {
            ...
            if(dig.show("Modification","Vous voulez modifier l'etat de cette demande ?","Annuler","Oui")) {
                dig.dispose();
            }
            else {
                dig.dispose();
                 }
                if(ServiceService.getInstance().modifierDemande(rec)) {
                    new ListDemandeForm(res).show();
                }
