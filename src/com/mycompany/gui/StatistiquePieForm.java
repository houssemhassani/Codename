...
import com.mycompany.services.ServiceCitoyen;
...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_citoyen_non_confirmée = ServiceCitoyen.getInstance().citoyenss().getConfirmee();
    private double nbr_citoyen_confirmée = ServiceCitoyen.getInstance().citoyens().getConfirmee();
    private double nbr_citoyen=nbr_citoyen_confirmée+nbr_citoyen_non_confirmée;
...
BaseForm form;
        ...
        RadioButton popular = RadioButton.createToggle("Citoyen Confirmée", barGroup);
        popular.setUIID("SelectBar");
        RadioButton feedback = RadioButton.createToggle("Citoyen non confirmée", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutCitoyenForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        //double total = nbr_citoyen_non_confirmée + nbr_citoyen_confirmée;
        
        //values
        double prcntFeed = (nbr_citoyen_confirmée *100)/nbr_citoyen;
        
        double prcntRec = (nbr_citoyen_non_confirmée * 100)/nbr_citoyen;
        ...
        String []messages = {
            "Statistique Citoyen confirmée & citoyen non confirmé % citoyen"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Citoyen non confirmée",prcntRec);
        series.add("Citoyen Confirmée",prcntFeed);
        //series.add("Citoyens ",nbr_citoyen);
