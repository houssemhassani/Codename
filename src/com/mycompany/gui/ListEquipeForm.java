...
public class ListEquipeForm extends BaseForm{
    ...
    public ListEquipeForm(Resources res ) {
        ...
        setTitle("Ajout Nouvelle Equipe");
        ...
        RadioButton mesListes = RadioButton.createToggle("Les Equipe", barGroup);
        mesListes.setUIID("SelectBar");
        RadioButton liste = RadioButton.createToggle("Autres", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Ajouter Equipe", barGroup);
        partage.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");

                ////lehne nthabet ken chnbadal fiha wala 
    ...
    private void addButton(Image img, Equipe e1, Resources res) {
        ...
        Label LMAP = new Label("MAP EQUIPE");
        LMAP.setUIID("NewsTopLine");
        Style MapStyle = new Style(LMAP.getUnselectedStyle());
        MapStyle.setFgColor(0xf22f1f);
        FontImage MAPImage = FontImage.createMaterial(FontImage.MATERIAL_DELETE, MapStyle);
        LMAP.setIcon(MAPImage);
        LMAP.setTextPosition(RIGHT);
        LMAP.addPointerPressedListener(l -> {
            //System.out.println("hello update");
            int X = e1.getNumEquipe();
            int Y = e1.getNumEquipe();
            new MapForm(X,Y);
        });
        //supprimer button
