...
public class ListPublicationForm extends BaseForm {
    ...
    public ListPublicationForm(Resources res){
       ...
       ArrayList<Publication>list = ServicePublication.getInstance().affichagePublication();
        
        for(Publication rec : list ) {
             String urlImage ="back-logo.png";//image statique pour le moment ba3d taw fi  videos jayin nwarikom image 
       ...
       int height = Display.getInstance().convertToPixels(11.5f);
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if(dig.show("Suppression","Vous voulez supprimer cette publication ?","Annuler","Oui")) {
                ...
                if(ServicePublication.getInstance().deletePublication(rec.getId())) {
