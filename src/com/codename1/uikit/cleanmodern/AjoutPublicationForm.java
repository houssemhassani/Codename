...
public class AjoutPublicationForm extends BaseForm {
    ...
    public AjoutPublicationForm(Resources res){
        ...
        RadioButton mesListes = RadioButton.createToggle("Mes Publication", barGroup);
        ...
        TextField status = new TextField("", "enter status!!");
        status.setUIID("TextFieldBlack");
        addStringValue("status",status);
        
        TextField photo = new TextField("", "enter photo!!");
        ...
        addStringValue("photo",photo);
         ...
         btnAjouter.addActionListener((e)->{
             ...
             try{
                 ...
                 if(status.getText().equals("")||photo.getText().equals("")){
                 
                     Dialog.show("veuiller verifier les données","","Annuler","OK");
                 }
                 else{
                     InfiniteProgress ip = new InfiniteProgress();
                     final Dialog iDialog = ip.showInfiniteBlocking();
           
                      Publication p = new Publication (String.valueOf(status.getText()).toString(),String.valueOf(photo.getText()).toString());
